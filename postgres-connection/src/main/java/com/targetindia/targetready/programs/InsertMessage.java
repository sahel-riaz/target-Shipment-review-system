...
import com.targetindia.targetready.entity.Dimension;
...
public class InsertMessage {
    ...
    public static void main(String[] args) {
        try(EntityManager em = JpaUtil.createEntityManager();){
            ...
            for (Package pd: pckg){
                pd.setShipmentId(shpId);
                /*pd.setLength(pd.getDimensions_cm().getLength());
                pd.setWidth(pd.getDimensions_cm().getWidth());
                pd.setHeight(pd.getDimensions_cm().getHeight());*/
