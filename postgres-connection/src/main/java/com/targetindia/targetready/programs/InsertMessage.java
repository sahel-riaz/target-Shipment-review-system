...
public class InsertMessage {
    ...
    public static void main(String[] args) {
        try(EntityManager em = JpaUtil.createEntityManager();){
            ...
            //System.out.println(sendersLocation.getLocationId());
            //sendersLocation = shipment.getSender();

            Location recipientsLocation = shipment.getRecipient();
            //System.out.println(recipientsLocation.getLocationId());
            //recipientsLocation= shipment.getRecipient();
