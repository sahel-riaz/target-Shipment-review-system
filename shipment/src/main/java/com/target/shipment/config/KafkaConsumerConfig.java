package com.target.shipment.config;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, Shipment> consumerFactory() {
        JsonDeserializer<Shipment> deserializer = new JsonDeserializer<>(Shipment.class);
        deserializer.addTrustedPackages("*");

        Map<String, Object> props = new HashMap<>();
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "localhost:9092");
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "com.target");
